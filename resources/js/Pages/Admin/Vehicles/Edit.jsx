...
export default function AdminVehicleEdit({ auth, vehicle }) {
    const { data, setData, put, processing, errors } = useForm({
        unit_code: vehicle.unit_code || '',
        name: vehicle.name || '',
        type: vehicle.type || 'supercar',
        ...
        <AdminLayout auth={auth}>
            ...
            <div className="max-w-4xl mx-auto animate-fade-in-up">
                <div className="mb-8 flex items-center gap-4">
                    ...
                    <h1 className="text-3xl font-bold tracking-tight">Edit Kendaraan</h1>
                </div>
                        ...
                        <form onSubmit={submit} className="flex flex-col gap-6 relative z-10">
                            ...
                            <div>
                                ...
                                <p className="text-[10px] text-gray-600 mt-1.5 flex items-center gap-1">
                                    ...
                                    Kode harus unik. Tidak boleh sama dengan unit lain.
                                </p>
